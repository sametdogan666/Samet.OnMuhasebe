...
public class OnMuhasebeBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "9cfdd667-74e5-4d39-b1fa-9b660c9cf225");
            });
        }
    }
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles("/Samet.OnMuhasebe.Blazor.styles.css");
                }
            );
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<OnMuhasebeDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Samet.OnMuhasebe.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<OnMuhasebeDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Samet.OnMuhasebe.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<OnMuhasebeApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Samet.OnMuhasebe.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<OnMuhasebeApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Samet.OnMuhasebe.Application"));
